...
"""
        ...
        def get_temporary_link(request: Request):
            try:
                temp_token = self.api_key_manager.create_temporary_link_token()
                # Construct the full URL with hostname pointing to the frontend page
                base_url = f"{request.url.scheme}://{request.url.netloc}"
                temp_link = f"{base_url}/boba/generate-api-key?token={temp_token}"
