...
def test_documents_chat(mocker):
    ...
    mocker.patch(
        "shared.services.embeddings_service.EmbeddingsService.similarity_search_on_single_document_with_scores",
        return_value=[(document, 0.3) for document in documents],
    )
