...
const CreativeMatrix = () => {
  ...
  const [dimensionValues, setDimensionValues] = useState([
    ["Dim 1 Value 1", "Dim 1 Value 2"],
    ["D2 Value 1", "D2 Value 2"],
  ]);
  ...
  const addDimensionValue = (index) => {
    ...
    newDimensionValues[index].push(
      "Dim " + (index + 1) + " value " + (newDimensionValues[index].length + 1),
    );
  ...
  return (
    <div id="canvas">
      ...
      <div style={{ marginTop: 20 }}>
        ...
        >
          <div>
            <Button size="small" type="primary" onClick={addDimension}>
              Add Dimension
            </Button>
              ...
              return (
                <div style={{ marginTop: 10 }}>
                  <Input
                    ...
                    key={index}
                    value={dimension}
                    onChange={(e) => updateDimension(e, index)}
                  />
                  {dimensions.length > 2 && (
                    <Button
                      size="small"
                      ...
                      danger
                      onClick={(e) => deleteDimension(e, index)}
                    >
                      <AiOutlineDelete />
                    </Button>
                  )}
                      ...
                      return (
                        <div className="dimension-value">
                          <Input
                            ...
                            value={value}
                            onChange={(e) =>
                              updateDimensionValue(e, index, valueIndex)
                            }
                          />
                          <Button
                            size="small"
                            ...
                            danger
                            onClick={() =>
                              deleteDimensionValue(index, valueIndex)
                            }
                          >
                            <AiOutlineDelete />
                          </Button>
                  ...
                  <Button
                    ...
                    type="primary"
                    style={{ marginLeft: 20 }}
                    onClick={() => addDimensionValue(index)}
                  >
                    Add value
                  </Button>
                </div>
        ...
        <div>
          <table style={{ width: "95%" }}>
            ...
            <tbody style={{ border: "1px solid silver" }}>
              {dimensions[1] &&
                dimensionValues[1]?.map((rowValue, index) => {
                  return (
                    <tr>
                      <td>
                        <b>{rowValue}</b>
