...
const SavedIdeas = () => {
  ...
  const onSearch = (e) => {
    ...
    if (v.trim() === "") {
      ...
      const matchingIdeas = ideas.filter((obj) =>
        Object.values(obj).some((val) => val.includes(v)),
      );
        ...
        {filteredIdeas?.map((idea, i) => {
          return (
            <Card
              ...
              title={
                <Space direction="vertical">
                  <div style={{ marginTop: 15 }}>
                    <Tag color="blue" style={{ margin: 0 }} size="small">
                      {idea.type}
                    </Tag>
                  </div>
                  <div>
              ...
              actions={[
                <Button danger onClick={() => deleteIdea(i)}>
                  Delete
                </Button>,
              ]}
            >
