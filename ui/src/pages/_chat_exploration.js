    ...
    <div className="chat-exploration">
      <div className="chat-log">
        <div className="chat-message">
          <b>Boba:</b> In this {item.type}, {item.summary}{" "}
        </div>
        ...
        <div className="chat-message">
          {
            <div className="prompt-suggestions">
              <Space>
                <Button
                  size="small"
                  onClick={() => setPrompt("Give me an example")}
                >
                  Give me an example
                </Button>
                <Button
                  size="small"
                  onClick={() => setPrompt("Can you be more specific?")}
                >
              ...
              {item.type === "scenario" && (
                <Button
                  ...
                  size="small"
                  onClick={() =>
                    setPrompt("Create a storyboard for this scenario")
                  }
                >
              ...
              {item.type === "strategy" && (
                <Button
                  ...
                  size="small"
                  onClick={() =>
                    setPrompt("Generate more strategies like this one")
                  }
                >
                  Generate more strategies like this one
                </Button>
              )}
              {item.type === "concept" && (
                <Button
                  ...
                  size="small"
                  onClick={() =>
                    setPrompt("Give me some questions to explore this concept")
                  }
                >
                  Give me some questions to explore this concept
                </Button>
              )}
              {item.type === "concept" && (
                <Button
                  ...
                  size="small"
                  onClick={() =>
                    setPrompt("Create a user journey for this concept")
                  }
                >
                  Create a user journey for this concept
                </Button>
              )}
            </div>
          }
