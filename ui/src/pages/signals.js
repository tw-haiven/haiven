    ...
    <>
      ...
      <div id="canvas">
        <div id="prompt-center">
          ...
          <br /><br />
          Analysis Type <Select defaultValue={'company'} onChange={handleSelectChange} style={{ width: 200 }} disabled={isLoading}
            options={[
          ...
          <span style={{marginTop: 7, display: 'inline-block'}}>Analysis prompt:</span>&nbsp;
          <Search placeholder="enter company name and press enter to analyze"
