  ...
  return (
    <div className="selected-items-menu">
      ...
      <Space wrap>
        ...
        <Button type="primary" onClick={onClickTestStrategies}>
    ...
    <>
      ...
      <div id="canvas">
        <div id="prompt-center">
          ...
          <div style={{ display: "inline" }}>
            <Select
              ...
              options={[
                {
                  value: "scenario",
                  label: "Strategic prompt",
                  disabled: true,
                },
              ]}
            ></Select>
            <Search
              placeholder="enter a prompt and press enter to generate strategies"
              value={prompt}
              onChange={(e, v) => {
            ...
            return (
              <div key={"subprompt-" + i} style={{ marginTop: 5 }}>
                ...
                <Input
                  ...
                  placeholder="enter a potential future scenario"
                  value={x.text}
          ...
          <Button
            style={{ marginTop: 5, width: 180 }}
            onClick={onAddSubprompt}
            disabled={isLoading}
          >
            Add subprompt
          </Button>
